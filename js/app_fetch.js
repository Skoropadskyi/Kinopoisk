...
function apiSearch(event) {
	...
	const server = 'https://api.themoviedb.org/3/search/multi?api_key=43ec5ecf5e49546660cf625c7bfa329b&language=ru&query=' + searchText;
...
function showFullInfo(){
	...
	if(this.dataset.type === 'movie'){
		url = 'https://api.themoviedb.org/3/movie/' + this.dataset.id + '?api_key=43ec5ecf5e49546660cf625c7bfa329b&language=ru'
	}else if(this.dataset.type === 'tv'){
		url = 'https://api.themoviedb.org/3/tv/' + this.dataset.id + '?api_key=43ec5ecf5e49546660cf625c7bfa329b&language=ru'
	}else {
...
fetch(url)
		...
		.then(function(output){
			...
			<div class="col-4">
				...
				${(output.imdb_id) ? `<p class='text-center'><a href="https://imdb.com/title/${output.imdb_id}">Страница на IMDB.com</a></p>` : ''}
			</div>
			<div class="col-8">
...
document.addEventListener('DOMContentLoaded', function(){
	fetch('https://api.themoviedb.org/3/trending/all/week?api_key=43ec5ecf5e49546660cf625c7bfa329b&language=ru')
		.then(function(value){
			if(value.status !== 200){
				return Promise.reject(new Error('Ошибка'));
			}
